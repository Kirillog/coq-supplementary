...
Section S.
  ...
  *)
  ...
  Proof. unfold state_equivalent. tauto. Qed.

  Lemma st_equiv_symm (st st': state) (H: st ~~ st') : st' ~~ st.
  Proof. unfold state_equivalent. intros x a. split; intros; apply H; assumption. Qed.

  Lemma st_equiv_trans (st st' st'': state) (H1: st ~~ st') (H2: st' ~~ st'') : st ~~ st''.
  Proof. unfold state_equivalent. intros. split; intros.
